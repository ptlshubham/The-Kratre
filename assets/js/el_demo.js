...
var Frontend = /*#__PURE__*/function (_elementorModules$Vie) {
  ...
  (0, _createClass2.default)(Frontend, [{
    ...
    value: function addIeCompatibility() {
      ...
      var msieCss = '<link rel="stylesheet" id="elementor-frontend-css-msie" href="' + this.config.urls.assets + 'assets/css/frontend-msie.min.css?' + this.config.version + '" type="text/css" />';
